    ...
    >
      <defs>
        <radialGradient id="cv-ground" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0%" stopColor="rgba(36, 172, 183, 0.55)" />
          <stop offset="40%" stopColor="rgba(36, 172, 183, 0.18)" />
          <stop offset="100%" stopColor="rgba(36, 172, 183, 0)" />
        </radialGradient>
        <linearGradient id="cv-glow" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#24acb7" />
          <stop offset="100%" stopColor="#1e8e97" />
        </linearGradient>
      ...
      <g stroke="#24acb7" strokeWidth="2.3" fill="none">
      ...
      <g fill="none" stroke="#24acb7" strokeWidth="2.5" strokeLinejoin="round" strokeLinecap="round">
        {/* Main body outline */}
        <path d="
          M180 240
      ...
      <g>
        ...
        <ellipse cx="525" cy="158" rx="38" ry="42" fill="none" stroke="#24acb7" strokeWidth="1.4" opacity="0.55" />
        {/* Visor */}
        <path
      ...
      <g>
        <rect
          ...
          strokeWidth="2.2"
        />
        <line x1="430" y1="260" x2="720" y2="260" stroke="#24acb7" strokeWidth="1" opacity="0.5" />
        <text
          x="575"
          y="287"
      ...
      {/* Rear wheel */}
      <g>
        <circle cx="290" cy="335" r="58" fill="#06090b" stroke="#24acb7" strokeWidth="2.4" />
        <circle cx="290" cy="335" r="32" fill="#0a0f12" stroke="#24acb7" strokeWidth="1.6" />
        <circle cx="290" cy="335" r="9" fill="#24acb7" />
        {/* Speed lines / brake duct hint */}
        <path d="M180 335 L 230 335" stroke="#24acb7" strokeWidth="1.2" opacity="0.5" />
      </g>

      {/* Front wheel */}
      <g>
        <circle cx="855" cy="335" r="62" fill="#06090b" stroke="#24acb7" strokeWidth="2.4" />
        <circle cx="855" cy="335" r="34" fill="#0a0f12" stroke="#24acb7" strokeWidth="1.6" />
        <circle cx="855" cy="335" r="10" fill="#24acb7" />
      </g>

      {/* Subtle motion lines under wheels */}
      <g opacity="0.4" stroke="#24acb7" strokeWidth="1">
