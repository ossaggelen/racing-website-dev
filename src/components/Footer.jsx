...
export default function Footer() {
  ...
  const links = [
    { href: '#/', key: 'home' },
    { href: '#/formula-student', key: 'formulaStudent' },
  ...
  return (
    <footer id="contact" className="bg-[#050709] py-16 px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-[1.2fr_1fr] gap-10">
        <div>
          <a href="#home" className="inline-flex flex-col leading-none font-display mb-6">
            <span className="text-2xl tracking-wide">ITU</span>
            <span className="text-[10px] tracking-[0.4em] text-accent mt-1">RACING</span>
          </a>
